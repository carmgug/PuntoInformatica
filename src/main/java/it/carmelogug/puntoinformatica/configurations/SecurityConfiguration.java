...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter { //estendiamo la classe WebSecurityConfigureAdapter e quindi Spring eseguirà questa configurazione invece di quella di fefault.
